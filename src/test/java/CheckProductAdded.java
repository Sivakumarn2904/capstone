...
public class CheckProductAdded {
    ...
    public void verifyTheProductIsAdded() throws InterruptedException {
        ...
        if (soldoutElement.contains("Sold out")){
            ...
            element.click();
            String promtMessage = driver.findElement(By.xpath("//h2[contains(text(),'Item added to your cart')]")).getText();
            Assert.assertEquals(promtMessage.contains("Item added to your cart'"),"Item added to your cart");
            String cartCount = driver.findElement(By.xpath("//a[@id='cart-notification-button']")).getText();
            Assert.assertNotEquals(cartCount,"View my cart (1)");
        }
        Thread.sleep(5000);
        driver.quit();
